...
public class ListCategoryExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("List Category Expense");
        ...
        categoryRecyclers = new CategoryRecyclers(this, categoryList) {
            ...
            public void onEditItem(Category itemTrip) {
                Intent intent = new Intent(ListCategoryExpenseActivity.this, AddCategoryActivity.class);
    ...
    public void dialogDelete(final Category itemTrip, final int i){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                position = i;
                categoryViewModel.deleteCategory(ListCategoryExpenseActivity.this,itemTrip.getId_category());
    ...
    public void getCategory(){
        progressDialogShowing();
        categoryViewModel.getCategory("expense",this);
    }
    ...
    public void ResultCategory(String Response){
        try {
            ...
            Log.d("cekResponExpenseList",message);
    ...
    public void Result(String Response){
        try {
            ...
            if (Status.equals("Success")){
                progressDialogDismiss();
                AlertDialog.Builder builder = new AlertDialog.Builder(ListCategoryExpenseActivity.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ListCategoryExpenseActivity.this, MainActivity.class);
